...
<h2 style="text-align: center;">Veuillez se connecter</h2>
        ...
        <form class="container" method="POST" action="process.php">
                    ...
                    <small class="text-body-secondary">En cliquant sur se connecter, vous acceptez les termes d'utilisationss.</small>
                    <hr class="my-4">
